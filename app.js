...
function RexyIcon({ costume = "basic", size = 60, alt = "", style = {} }) {
  ...
  return /* @__PURE__ */ React.createElement(
    "img",
    {
      ...
      style: { height: size + "px", width: "auto", display: "block", flex: "none", ...style }
    }
  );
}
  ...
  if (holeData) {
    ...
    Object.keys(holeData).forEach((k) => {
      ...
      const shots = hd.shots.map((s) => {
        let ns = s;
        if (courseChanged && newPar != null && s.par !== newPar) ns = { ...ns, par: newPar };
...
function calcSimpleSG(simpleHoleData, holePars, hcp, holeLengths, avgDrive) {
  const HC = hcp ?? 0, DRIVE = avgDrive || 220, ADV = DRIVE * 0.85;
  const OFFSET = 3.1;
  let __proExp = 0;
...
function buildTodayFocus(rounds, hcp, avgDrive) {
  try {
    ...
    const sgs = [];
    completed.forEach((r) => {
      const sa = calcAnalytics(r, r.hcp ?? null, teeRates, avgDrive);
...
function buildGrowthPoints(rounds) {
  try {
    ...
    const calc = (list) => {
      ...
      const w = list.reduce((a, r) => a + ((r.holePars?.length ?? 18) <= 12 ? 0.5 : 1), 0);
      if (!w) return null;
      ...
      if (venue) {
        ...
        if (holeLengths.some((v) => v != null)) {
          try {
            ...
            return { ...sa2, sg, sgReady: true, isDetailMode: true };
          } catch (e) {
          }
        }
      }
    }
    return { ...sa2, sg: null, sgReady: false, isDetailMode: true };
  }
    ...
    if (venue) {
      ...
      if (holeLengths.some((v) => v != null)) {
        try {
          ...
          return { ...sa, sg, sgReady: true, isDetailMode: false };
        } catch (e) {
        }
      }
    }
  }
  return { ...sa, sg: null, sgReady: false, isDetailMode: false };
}
...
function decomposeTeeSG(scopeRounds, hcp, avgDD) {
  const HC = hcp ?? 0, driveRef = avgDD || 220;
  const lieOf = (s) => {
    if (s.subType === "bunker") return "sand";
    if (s.subType === "1pen" || s.subType === "ob") return "fairway";
    if (s.quality === "\u25CB") return "fairway";
...
function decomposeLongSG(scopeRounds, hcp) {
  const HC = hcp ?? 0, DRIVE = 220, ADV = DRIVE * 0.85;
  const lieOf = (s) => {
    if (!s) return "fairway";
    if (s.subType === "bunker") return "sand";
    if (s.subType === "1pen" || s.subType === "ob") return "fairway";
...
function generateDiagnosis(sa, shd, hcp, rounds, roundId, roundCount = 1, scoreOverride = null, sgOverride = null, sg5 = null, trendHcp = null) {
  ...
  if (usedSG) {
    ...
    const sdSGBase = Math.max(2, (hcp ?? 0) * 0.2 + 2);
  ...
  ].filter((c) => c.sg != null).map((c) => ({ ...c, insight: insights[c.key] })).sort((a, b) => a.sg - b.sg) : null;
  if (sgRank) {
    weakestCat = sgRank[0];
  ...
  if (sa.sgReady && sa.sg) {
    ...
    if (negItems.length > 0) {
      ...
      improveItem = { ...it, diagnosis: diag, advice: adv };
    }
    ...
    if (posItems.length > 0) {
      const it = posItems[0];
      strongItem = { ...it, oneLiner: causeStrong[it.key] || "\u597D\u8ABF\u3092\u7DAD\u6301\u3057\u3088\u3046\uFF01" };
    }
    ...
    elemRanking = sgCands.slice().sort((a, b) => a.sg - b.sg).map((it) => ({ ...it, advice: rankElementAdvice(it.key, it.sg, rankScope, hcp, rankMode, rankAvgDD) }));
  }
...
function AiDiagnosisPanel({ sa, sa5 = null, shd, hcp, rounds, roundId, teeRates = null, showTrend = true, label = "AI \u30B9\u30B3\u30A2\u8A3A\u65AD", roundCount = null, dateRange = null, radarSlot = null, rexyTip = false, trendHcp = null }) {
  ...
  let d;
  let sg5avg = null;
  if (sa5 && sa5.sg?.totalSG != null) {
    sg5avg = sa5.sg.totalSG;
  }
  try {
    d = generateDiagnosis(sa, shd, hcp, rounds, roundId, roundCount, sa5?.totalScore ?? null, sg5avg, sa5?.sg ?? null, trendHcp);
  } catch (e) {
    return null;
  }
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { marginTop: "12px" } }, /* @__PURE__ */ React.createElement("style", null, `
    ...
    const _c = (v) => Math.abs(v) < 0.05 ? "#64748b" : v > 0 ? "#16a34a" : "#2563eb";
    return /* @__PURE__ */ React.createElement("div", { style: { fontSize: "9px", color: "#94a3b8", marginTop: "3px", whiteSpace: "nowrap" } }, "TS+LG+SG ", /* @__PURE__ */ React.createElement("span", { style: { color: _c(_shot), fontWeight: "800" } }, _f(_shot)), /* @__PURE__ */ React.createElement("span", { style: { margin: "0 3px", color: "#cbd5e1" } }, "\uFF0B"), "PT ", /* @__PURE__ */ React.createElement("span", { style: { color: _c(_putt), fontWeight: "800" } }, _f(_putt)));
    ...
    const v20 = (k) => sa.sg ? sa.sg[k] ?? null : null;
    const hasCmp = !!(sa5 && sa5.sg);
    const v5 = (k) => hasCmp ? sa5.sg[k] ?? null : null;
    ...
    return /* @__PURE__ */ React.createElement("div", null, hasCmp && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "flex-end", gap: "6px", fontSize: "8px", color: "#94a3b8", marginBottom: "6px" } }, /* @__PURE__ */ React.createElement("span", { style: { minWidth: "38px", textAlign: "right", fontWeight: "700" } }, "\u76F4\u8FD15R"), /* @__PURE__ */ React.createElement("span", { style: { minWidth: "26px", textAlign: "right" } }, "20R"), /* @__PURE__ */ React.createElement("span", { style: { minWidth: "16px", textAlign: "right" } }, "\u50BE\u5411")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "6px", marginBottom: "5px" } }, /* @__PURE__ */ React.createElement("span", { style: { width: "26px", flexShrink: 0 } }), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, position: "relative", height: "11px", fontSize: "9px", fontWeight: "800", lineHeight: 1 } }, /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", left: 0, top: 0, color: "#16a34a" } }, "\uFF0B\uFF08Gain\uFF09"), /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", left: "50%", top: 0, transform: "translateX(-50%)", color: "#94a3b8" } }, "0"), /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", right: 0, top: 0, color: "#2563eb" } }, "\u25B3\uFF08Loss\uFF09")), /* @__PURE__ */ React.createElement("span", { style: { minWidth: "38px", flexShrink: 0 } }), hasCmp && /* @__PURE__ */ React.createElement("span", { style: { minWidth: "26px", flexShrink: 0 } }), hasCmp && /* @__PURE__ */ React.createElement("span", { style: { minWidth: "16px", flexShrink: 0 } })), /* @__PURE__ */ React.createElement("div", { style: { position: "relative" } }, ITEMS.map((it) => /* @__PURE__ */ React.createElement(Row, { key: it.key, abbr: it.abbr, main: hasCmp ? v5(it.key) : v20(it.key), cmp: v20(it.key) })), v20("bunkerScore") != null && /* @__PURE__ */ React.createElement("div", { style: { marginTop: "8px", paddingTop: "8px", borderTop: "1px solid #e2e8f0" } }, /* @__PURE__ */ React.createElement(Row, { abbr: "BK", main: hasCmp ? v5("bunkerScore") : v20("bunkerScore"), cmp: v20("bunkerScore") })), /* @__PURE__ */ React.createElement("div", { "aria-hidden": "true", style: { position: "absolute", top: 0, bottom: 0, left: 0, right: 0, display: "flex", alignItems: "stretch", gap: "6px", pointerEvents: "none" } }, /* @__PURE__ */ React.createElement("span", { style: { width: "26px", flexShrink: 0 } }), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, position: "relative" } }, /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", left: "50%", top: 0, bottom: 0, width: "2px", marginLeft: "-1px", background: "#64748b", borderRadius: "1px" } })), /* @__PURE__ */ React.createElement("span", { style: { minWidth: "38px", flexShrink: 0 } }), hasCmp && /* @__PURE__ */ React.createElement("span", { style: { minWidth: "26px", flexShrink: 0 } }), hasCmp && /* @__PURE__ */ React.createElement("span", { style: { minWidth: "16px", flexShrink: 0 } }))), sa.sg.holes && sa.sg.holes.length > 0 && (() => {
      ...
      hl.putts = new Set(rows.filter((h) => (h.putts ?? 0) >= 3).map((h) => h.hole));
      const th = { position: "sticky", left: 0, background: "#fff", padding: "2px 6px", fontWeight: "700", textAlign: "left", zIndex: 1, whiteSpace: "nowrap" };
      return /* @__PURE__ */ React.createElement("div", { style: { marginTop: "12px", paddingTop: "12px", borderTop: "1px solid #e2e8f0" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: "9px", fontWeight: "700", color: "#94a3b8", marginBottom: "2px", letterSpacing: "0.06em" } }, "5\u8981\u7D20\u30DB\u30FC\u30EB\u30D0\u30A4\u30DB\u30FC\u30EB", /* @__PURE__ */ React.createElement("span", { style: { fontWeight: "400", color: "#94a3b8" } }, "\uFF08\u30CF\u30A4\u30E9\u30A4\u30C8\u3055\u308C\u305F\u90E8\u5206\u3092\u78BA\u8A8D\u3057\u3066\u30B9\u30B3\u30A2\u6539\u5584\u306B\u5F79\u7ACB\u3066\u3088\u3046\uFF09")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: "9px", color: "#94a3b8", marginBottom: "6px" } }, "\u2192 \u6A2A\u30B9\u30AF\u30ED\u30FC\u30EB\u53EF\uFF0F\u5C0F\u6570\u7B2C2\u4F4D\u4EE5\u4E0B\u56DB\u6368\u4E94\u5165"), /* @__PURE__ */ React.createElement("div", { style: { overflowX: "auto", WebkitOverflowScrolling: "touch" } }, /* @__PURE__ */ React.createElement("table", { style: { borderCollapse: "collapse", fontSize: "9px", whiteSpace: "nowrap" } }, /* @__PURE__ */ React.createElement("tbody", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", { style: { ...th, color: "#94a3b8" } }, "\u30DB\u30FC\u30EB"), rows.map((h) => /* @__PURE__ */ React.createElement("td", { key: h.hole, style: { padding: "2px 5px", textAlign: "center", fontWeight: "700", color: "#475569" } }, dispHoleNum(h.hole))), /* @__PURE__ */ React.createElement("td", { style: { padding: "2px 6px", textAlign: "center", fontWeight: "800", color: "#1e293b", borderLeft: "1px solid #e2e8f0" } }, "\u8A08")), RL.map((rl) => /* @__PURE__ */ React.createElement("tr", { key: rl.k, style: { borderTop: "1px solid #f1f5f9" } }, /* @__PURE__ */ React.createElement("td", { onClick: rl.k === "score" ? () => setHbhSym((s) => !s) : void 0, style: { ...th, color: rl.k === "score" ? "#0ea5e9" : "#64748b", ...rl.k === "score" ? { cursor: "pointer", userSelect: "none" } : {} } }, rl.label, rl.k === "score" && /* @__PURE__ */ React.createElement("span", { style: { marginLeft: "3px", fontSize: "9px", opacity: 0.75 } }, "\u21C4")), rows.map((h) => {
        ...
        const _ct = _sym ? _sym.sym : rl.raw ? v ?? "\u2212" : fmt2(v);
...
async function ocrExtractVertical(img, words, fmt2) {
  ...
  if (holeYs.length >= 16) {
    ...
    for (var i = 0; i < frontYs.length; i++) {
      ...
      front.push({ dispHole: frontNums[i], par: ps.par != null ? ps.par : 4, score: ps.score, putts: puttAt(frontYs[i], ps.score), teeEval: "\u25CB", ...detailCountsAt(frontYs[i]) });
    }
    for (var j = 0; j < backYs.length; j++) {
      var ps2 = parScoreAt(backYs[j]);
      back.push({ dispHole: backNums[j], par: ps2.par != null ? ps2.par : 4, score: ps2.score, putts: puttAt(backYs[j], ps2.score), teeEval: "\u25CB", ...detailCountsAt(backYs[j]) });
    }
  }
  ...
  return /* @__PURE__ */ React.createElement("div", { style: S.card({ marginBottom: "12px" }) }, /* @__PURE__ */ React.createElement("label", { style: S.lbl }, "\u6B8B\u308A\u8DDD\u96E2\u5225 \u671F\u5F85\u6253\u6570\uFF08\u8A73\u7D30\u30E2\u30FC\u30C9\uFF09"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: "5px", marginBottom: "8px" } }, ES_SEGMENTS.map((sg, i) => {
    ...
    return /* @__PURE__ */ React.createElement(
      "button",
      {
        ...
        disabled: !enabled,
        onClick: () => setSeg(i),
        style: { ...btn(i === segIdx), opacity: enabled ? 1 : 0.4, fontSize: "10px", padding: "6px 2px" }
      },
      sg.name
    );
...
function DetailShotList({ r, S, open, onToggle, expandedMemos, onToggleMemo, exportUnlocked, onExport }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { marginTop: "10px", paddingTop: "10px", borderTop: "1px solid #e2e8f0" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "6px" } }, /* @__PURE__ */ React.createElement("div", { onClick: onToggle, style: { display: "flex", alignItems: "center", gap: "6px", cursor: "pointer", userSelect: "none", flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("label", { style: { ...S.lbl, marginBottom: "0", cursor: "pointer" } }, "\u30B9\u30C8\u30ED\u30FC\u30AF\u4E00\u89A7"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: "10px", color: "#f59e0b", fontWeight: "700" } }, open ? "\u25BC" : "\u25B6")), exportUnlocked && /* @__PURE__ */ React.createElement("button", { onClick: (e) => {
    e.stopPropagation();
...
function DrumPicker({ value, onChange, min, max, step, label, accent = "#16a34a" }) {
  ...
  const idxOf = (v) => {
    ...
    return i < 0 ? Math.round(((v ?? min) - min) / step) : i;
  };
  useEffect(() => {
...
function ManualViewImpl({ DETAIL_FREE_LIMIT, DETAIL_PRICE_LABEL }) {
  ...
  ].map(({ n, req, d }) => /* @__PURE__ */ React.createElement("div", { key: n, style: M.field }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: "11px", fontWeight: "800", color: "#1e293b", marginBottom: "3px" } }, n, req && /* @__PURE__ */ React.createElement("span", { style: { fontSize: "9px", color: "#dc2626", marginLeft: "4px" } }, "\u5FC5\u9808")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: "10px", color: "#64748b", lineHeight: 1.5 } }, d)))), /* @__PURE__ */ React.createElement("div", { style: M.field }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: "11px", fontWeight: "800", color: "#1e293b", marginBottom: "3px" } }, "\u30D0\u30F3\u30AB\u30FC ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: "9px", color: "#64748b" } }, "\u4EFB\u610F")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: "10px", color: "#64748b" } }, "\u30D0\u30F3\u30AB\u30FC\u306B\u5165\u3063\u305F\u56DE\u6570\u30020\u306E\u307E\u307E\u3067\u3082OK\u3067\u3059\u3002"))), /* @__PURE__ */ React.createElement("div", { style: M.accentG }, /* @__PURE__ */ React.createElement("span", { style: M.lbl }, "\u30B9\u30C6\u30C3\u30D7 3 \u2014 \u30B7\u30E7\u30C3\u30C8\u8A55\u4FA1\u304C\u8D85\u91CD\u8981\uFF01"), /* @__PURE__ */ React.createElement("div", { style: { ...M.cardH, marginBottom: "5px" } }, "\u5404\u30B7\u30E7\u30C3\u30C8\u306E\u51FA\u6765\u3092 \u25CB \u25B3 \xD7 \u306E3\u6BB5\u968E\u3067\u5165\u529B"), /* @__PURE__ */ React.createElement("div", { style: M.body }, "\u6253\u6570\u3060\u3051\u3067\u306A\u304F\u300C\u3069\u306E\u30B7\u30E7\u30C3\u30C8\u304C\u826F\u304B\u3063\u305F\u304B\u30FB\u60AA\u304B\u3063\u305F\u304B\u300D\u3092\u8A18\u9332\u3059\u308B\u3053\u3068\u3067\u5F31\u70B9\u304C\u898B\u3048\u3066\u304D\u307E\u3059\u3002\u3053\u308C\u304C\u30B9\u30B3\u30A2\u6539\u5584\u306E\u6838\u5FC3\u3067\u3059\u3002")), /* @__PURE__ */ React.createElement("div", { style: M.cardG }, [
  ...
  ].map((t) => /* @__PURE__ */ React.createElement("div", { key: t, style: { display: "flex", gap: "7px", marginBottom: "5px" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "#0ea5e9", fontSize: "10px", marginTop: "1px", flexShrink: 0 } }, "\u25CF"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: "11px", color: "#64748b", lineHeight: 1.55 } }, t))))), /* @__PURE__ */ React.createElement("div", { style: M.hr }), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: "8px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "10px", marginBottom: "4px" } }, /* @__PURE__ */ React.createElement("div", { style: M.chBadge("#f59e0b") }, "3"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: M.secH }, "\u5206\u6790\u30FBSTATS\u3067\u30B9\u30B3\u30A2\u30A2\u30C3\u30D7"), /* @__PURE__ */ React.createElement("span", { style: M.secS }, "\u8A18\u9332\u3057\u305F\u30C7\u30FC\u30BF\u304B\u3089\u300C\u76F4\u3059\u3079\u304D\u30DD\u30A4\u30F3\u30C8\u300D\u3092\u898B\u3064\u3051\u3088\u3046\uFF01")))), REXY_IMAGES.basic10 && /* @__PURE__ */ React.createElement("div", { style: { marginBottom: "16px" } }, /* @__PURE__ */ React.createElement(RexyBubble, { costume: "basic10", size: 64 }, "\u8A18\u9332\u3057\u305F\u30C7\u30FC\u30BF\u304B\u3089\u300C\u76F4\u3059\u3079\u304D\u30DD\u30A4\u30F3\u30C8\u300D\u3092\u898B\u3064\u3051\u3088\u3046\uFF01")), /* @__PURE__ */ React.createElement("div", { style: M.accentA }, /* @__PURE__ */ React.createElement("span", { style: M.lbl }, "\u5206\u6790\u30DA\u30FC\u30B8\u3078"), /* @__PURE__ */ React.createElement("div", { style: { ...M.cardH, marginBottom: "5px" } }, "\u30D8\u30C3\u30C0\u30FC\u306E\u300C\u5206\u6790\u300D\u30BF\u30D6\u3092\u30BF\u30C3\u30D7"), /* @__PURE__ */ React.createElement("div", { style: M.body }, "\u5206\u6790\u30DA\u30FC\u30B8\u306F\u4E0A\u304B\u3089\u9806\u306B\u30BB\u30AF\u30B7\u30E7\u30F3\u304C\u4E26\u3073\u307E\u3059\u3002\u30C7\u30FC\u30BF\u304C\u63C3\u3063\u305F\u30BB\u30AF\u30B7\u30E7\u30F3\u304B\u3089\u9806\u306B\u8868\u793A\u3055\u308C\u307E\u3059\u3002")), /* @__PURE__ */ React.createElement("div", { style: M.cardG }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: "11px", fontWeight: "800", color: "#1e293b", marginBottom: "8px" } }, "\u5206\u6790\u30DA\u30FC\u30B8\u306E\u69CB\u6210"), [
  ...
  })), /* @__PURE__ */ React.createElement("div", { style: M.accentB }, /* @__PURE__ */ React.createElement("span", { style: M.lbl }, "STATS\u30DA\u30FC\u30B8\uFF08\u8A73\u7D30\u30E2\u30FC\u30C9\u306E\u4E0A\u7D1A\u5206\u6790\uFF09"), /* @__PURE__ */ React.createElement("div", { style: { ...M.cardH, marginBottom: "5px" } }, "\u30D8\u30C3\u30C0\u30FC\u306E\u300CSTATS\u300D\u30BF\u30D6"), /* @__PURE__ */ React.createElement("div", { style: M.body }, "1\u6253\u305A\u3064\u8A18\u9332\u3059\u308B\u8A73\u7D30\u30E2\u30FC\u30C9\u306E\u30C7\u30FC\u30BF\u304B\u3089\u3001\u3055\u3089\u306B\u7D30\u304B\u3044\u5206\u6790\u304C\u898B\u3089\u308C\u307E\u3059\u3002\u30C7\u30FC\u30BF\u304C\u306A\u3044\u3068\u304D\u306F\u300C\u8A73\u7D30\u30E2\u30FC\u30C9\u3067\u8A18\u9332\u3059\u308B\u3068\u898B\u3089\u308C\u307E\u3059\u300D\u3068\u6848\u5185\u304C\u51FA\u307E\u3059\u3002")), /* @__PURE__ */ React.createElement("div", { style: M.cardG }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: "11px", fontWeight: "800", color: "#1e293b", marginBottom: "8px" } }, "STATS\u30DA\u30FC\u30B8\u306E\u69CB\u6210"), [
...
const AnalyticsAIDiagnosisImpl = ({ rounds, avgDrive, effectiveHcp }) => {
  ...
  const buildAvgSa = (rList) => {
    const sList = rList.map((r) => calcAnalytics(r, effectiveHcp ?? null, teeRatesAna, avgDrive)).filter(Boolean);
...
const AnalyticsScoreChartImpl = ({ rounds, avgDrive, S, effectiveHcp = null }) => {
  ...
  const saList = recent.map((r) => {
    ...
    return {
      date: r.date,
      sa: calcAnalytics(r, effectiveHcp ?? null, teeRatesAna, avgDrive),
      // 推移グラフは統一HC
      is9H,
  ...
  const sgGetV = (sa, k) => useSG ? sa && sa.sg ? sa.sg[k] ?? null : null : sa ? sa[k] ?? null : null;
  ...
  const weightOf = (r) => (r.holePars?.length ?? 18) <= 12 ? 0.5 : 1;
  ...
  const saList20 = sc20all.map((r) => ({ sa: calcAnalytics(r, effectiveHcp ?? null, teeRatesAna20, avgDrive) })).filter((x) => x.sa);
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, (() => {
    ...
    const series = seriesDef.map((s) => ({ ...s, vals: saList.map((x) => sgGetV(x.sa, s.key)) }));
...
const calcRoundStats = (list) => {
  if (!list.length) return null;
  const statsWeight = list.reduce((a, r) => a + ((r.holePars?.length ?? 18) <= 12 ? 0.5 : 1), 0);
...
const AnalyticsStatsImpl = ({ rounds, handicap, profile, S }) => {
  ...
  const statRows = [
    { label: "\u5E73\u5747\u30B9\u30B3\u30A2", v5: fmt2(s5?.avgScore), v20: fmt2(s20.avgScore), color: "#16a34a", unit: "", n5: s5?.avgScore, n20: s20.avgScore, betterLow: true, diffUnit: "\u6253" },
    { label: "\u5E73\u5747\u30D1\u30C3\u30C8\u6570\uFF081H\uFF09", v5: fmt2(s5?.avgPuttPerHole), v20: fmt2(s20.avgPuttPerHole), color: "#94a3b8", unit: "\u6253", n5: s5?.avgPuttPerHole, n20: s20.avgPuttPerHole, betterLow: true, diffUnit: "\u6253" },
    { label: "\u5E73\u5747\u30C8\u30FC\u30BF\u30EB\u30D1\u30C3\u30C8\u6570\uFF0818H\uFF09", v5: fmt2(s5?.avgTotalPutts), v20: fmt2(s20.avgTotalPutts), color: "#64748b", unit: "\u6253", n5: s5?.avgTotalPutts, n20: s20.avgTotalPutts, betterLow: true, diffUnit: "\u6253" },
    { label: "\u30D1\u30FC\u30AA\u30F3\u7387", v5: fmtPct(s5?.girRate), v20: fmtPct(s20.girRate), color: "#fbbf24", unit: "", n5: s5?.girRate, n20: s20.girRate, betterLow: false, diffUnit: "pt" },
    { label: "\u5E73\u5747\u30D1\u30FC\u30AA\u30F3\u6570\uFF0818H\uFF09", v5: fmt2(s5?.avgGIR) + " \u56DE", v20: fmt2(s20.avgGIR) + " \u56DE", color: "#a78bfa", unit: "", n5: s5?.avgGIR, n20: s20.avgGIR, betterLow: false, diffUnit: "\u56DE" },
    { label: "\u30DC\u30AE\u30FC\u30AA\u30F3\u7387", v5: fmtPct(s5?.bogeyOnRate), v20: fmtPct(s20.bogeyOnRate), color: "#38bdf8", unit: "", n5: s5?.bogeyOnRate, n20: s20.bogeyOnRate, betterLow: false, diffUnit: "pt" },
    { label: "\u5E73\u5747\u30DC\u30AE\u30FC\u30AA\u30F3\u6570\uFF0818H\uFF09", v5: fmt2(s5?.avgBogeyOn) + " \u56DE", v20: fmt2(s20.avgBogeyOn) + " \u56DE", color: "#7dd3fc", unit: "", n5: s5?.avgBogeyOn, n20: s20.avgBogeyOn, betterLow: false, diffUnit: "\u56DE" },
    { label: "\u30EA\u30AB\u30D0\u30EA\u30FC\u7387", v5: fmtPct(s5?.recoveryRate), v20: fmtPct(s20.recoveryRate), color: "#fb923c", unit: "", n5: s5?.recoveryRate, n20: s20.recoveryRate, betterLow: false, diffUnit: "pt" },
    { label: "\u30D1\u30FC\u30D6\u30EC\u30A4\u30AF\u7387", v5: fmtPct(s5?.parBreakRate), v20: fmtPct(s20.parBreakRate), color: "#f472b6", unit: "", n5: s5?.parBreakRate, n20: s20.parBreakRate, betterLow: false, diffUnit: "pt" },
    { label: "OB\u6570\uFF0818H\uFF09", v5: fmt2(s5?.avgOB), v20: fmt2(s20.avgOB), color: "#dc2626", unit: "\u56DE", n5: s5?.avgOB, n20: s20.avgOB, betterLow: true, diffUnit: "\u6253", mult: 2 },
    { label: "\u30DA\u30CA\u30EB\u30C6\u30A3\u6570\uFF0818H\uFF09", v5: fmt2(s5?.avgPenalty), v20: fmt2(s20.avgPenalty), color: "#b91c1c", unit: "\u56DE", n5: s5?.avgPenalty, n20: s20.avgPenalty, betterLow: true, diffUnit: "\u6253" }
  ];
...
const AnalyticsPuttStatsImpl = ({ rounds, S }) => {
  ...
  const rows = PUTT_BANDS.map((b, i) => ({ label: b.label, ...distStats[i] })).filter((r) => r.total > 0);
...
const AnalyticsDistanceStatsImpl = ({ rounds, S }) => {
  ...
  allShots.forEach((s) => {
    const d = s.remainDistRaw != null && Number.isFinite(s.remainDistRaw) && s.remainDistRaw > 0 ? s.remainDistRaw : DIST_LABEL_MID[s.remainDist] ?? null;
  ...
  const rows = BANDS.map((b) => ({ label: b.label, ...distMap[b.key] })).filter((r) => r.total > 0);
...
const AnalyticsClubStatsImpl = ({ rounds, S }) => {
  ...
  const rows = Object.entries(clubMap).map(([club, v]) => ({ club, ...v })).sort((a, b) => clubOrder.indexOf(a.club) - clubOrder.indexOf(b.club));
...
const StatsCompareImpl = ({ rounds, S }) => {
  ...
  const toggleVenue = (cond, setter, key) => {
    ...
    setter(keep ? { ...cond, venues } : { ...cond, venues, tee: "all", green: "all" });
  };
  const selRows = [
  ...
  return /* @__PURE__ */ React.createElement("div", { style: S.card({ marginBottom: "12px" }) }, /* @__PURE__ */ React.createElement("label", { style: S.lbl }, "STATS\u6BD4\u8F03"), selRows.map(({ tag, cond, setter, color }) => /* @__PURE__ */ React.createElement("div", { key: tag, style: { marginBottom: "6px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: "6px", alignItems: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: "12px", fontWeight: "800", color, flexShrink: 0, width: "14px", textAlign: "center" } }, tag), /* @__PURE__ */ React.createElement(
    ...
    {
      value: cond.period,
      onChange: (e) => setter({ ...cond, period: e.target.value }),
      style: { ...S.input, width: "auto", flexShrink: 0, fontSize: "12px", padding: "8px" }
    },
    ...
    {
      value: cond.tee,
      onChange: (e) => setter({ ...cond, tee: e.target.value }),
      style: { ...S.input, flex: 1, minWidth: 0, fontSize: "11px", padding: "7px" }
    },
    ...
    {
      value: cond.green,
      onChange: (e) => setter({ ...cond, green: e.target.value }),
      style: { ...S.input, flex: 1, minWidth: 0, fontSize: "11px", padding: "7px" }
    },
    ...
    "span",
    {
      onClick: () => setter({ ...cond, venues: [], tee: "all", green: "all" }),
...
function GolfTracker() {
  ...
  useEffect(() => {
    ...
    const prevBk = readDailyBackup();
    if (prevBk && prevBk.date === today) {
      setDailyBackup(prevBk);
      return;
    }
    const payload = { date: today, rounds };
    try {
      localStorage.setItem(DAILY_BACKUP_KEY, JSON.stringify(payload));
      setDailyBackup(payload);
    } catch (_) {
      if (prevBk) setDailyBackup(prevBk);
    }
  }, [storageLoaded]);
  ...
  const saveProfile = (p) => {
    if (p && hasExportMarker(p.nickname)) {
      ...
      p = { ...p, nickname: stripExportMarker(p.nickname) };
    }
    setProfile(p);
  };
  useEffect(() => {
      ...
      if (raw) {
        ...
        if (Array.isArray(parsed)) {
          ...
          const migrated = parsed.map((r) => {
            const base = { ...r, shots: r.shots || [] };
            if (base.inputMode === "detail" && Object.keys(base.simpleHoleData || {}).length === 0 && base.holeData) {
              return { ...base, simpleHoleData: deriveSimpleHoleData(base.holeData, base.holePars) };
            }
            return base;
          });
          setRounds(migrated);
    ...
    try {
      ...
      if (raw) {
        ...
        if (hasExportMarker(parsed.nickname)) {
          ...
          setExportUnlocked(true);
          parsed = { ...parsed, nickname: stripExportMarker(parsed.nickname) };
          try {
  ...
  const recordShot = (optId, clubId = null, remainDist = null, pinDistLabel = null, remainDistRaw = null, pinDistMeters = null) => {
    ...
    setHoleData((prev) => ({
      ...
      [currentHole]: {
        ...
        pinDistM: pinDistMeters != null ? pinDistMeters : prev[currentHole]?.pinDistM,
  ...
  const savePinDistAndAdvance = (dist) => {
    ...
    if (dist !== null) {
      setHoleData((prev) => ({
        ...prev,
        [currentHole]: { ...prev[currentHole], pinDist: dist }
      }));
    }
  ...
  const undoLastShot = () => {
    ...
    setHoleData((p) => ({ ...p, [currentHole]: { shots: prev, state, done: state === "done", pinDist: void 0, extraPenalty: p[currentHole]?.extraPenalty } }));
  };
  const canRecordNew = (() => {
    ...
    if (inputMode === "simple" && res.courseChanged) {
      setSimpleHoleData((prev) => {
        ...
        Object.keys(n).forEach((k) => {
          ...
          if (n[k] && n[k].par != null && p != null && n[k].par !== p) n[k] = { ...n[k], par: p };
        });
        return n;
      });
    }
  ...
  const finishRound = () => {
    ...
    const courseName2 = currentRound?.course || "";
    const roundWeather = currentRound?.weather || null;
    const existingRec = (rounds || []).find((x) => x.id === currentRound?.id);
    const frozenHcp = existingRec !== void 0 ? existingRec.hcp ?? null : currentRound?.hcp ?? effectiveHcp;
    if (inputMode === "simple") {
      ...
      upsertRound({ ...currentRound, shots: [], holePars: [...holePars], simpleHoleData: { ...simpleHoleData }, inputMode: "simple", isComplete, hcp: frozenHcp });
      ...
      upsertRound({ ...currentRound, shots, holePars: [...holePars], holeData: { ...holeData }, simpleHoleData: derivedSimple, inputMode: "detail", isComplete, hcp: frozenHcp });
      setCurrentRound(null);
      setHoleData({});
    }
    if (isComplete && totalScore2 > 0 && (profile.bestScore === null || totalScore2 < profile.bestScore)) {
      saveProfile({ ...profile, bestScore: totalScore2 });
  ...
  const ocrHandleFile = async (e) => {
    ...
    try {
      ...
      const applyTee = (arr) => arr.map((h) => ({ ...h, teeEval: ocrDeriveTee(ex.fmt, h.par, h.fwKeepOk, h.oneOnOk) }));
  ...
  const ocrBackToData = () => {
    ...
    setOcrSel(null);
    setOcrDoneInfo(null);
    setProfileEdit({ ...profile, driveFrom: profile.driveFrom ?? 180, driveTo: profile.driveTo ?? 230 });
    setView("profile");
    try {
      window.scrollTo(0, 0);
    } catch (e) {
  ...
  const ocrSetSetup = (patch, editedKeys = []) => {
    setOcr((prev) => {
      if (!prev) return prev;
      const edited = { ...prev.setup.edited };
      editedKeys.forEach((k) => {
        edited[k] = true;
      });
      return { ...prev, setup: { ...prev.setup, ...patch, edited } };
    });
  };
  const ocrSetBuilt = (patch) => setOcr((prev) => prev ? { ...prev, built: { ...prev.built, ...patch } } : prev);
  const ocrStepCell = (hole, key, delta) => {
    setOcr((prev) => {
      if (!prev) return prev;
      const shd = { ...prev.built.simpleHoleData };
      const cur = { ...shd[hole] || {} };
      const base = cur[key] == null ? key === "putts" ? 2 : cur.par || 4 : cur[key];
      cur[key] = Math.max(key === "putts" ? 0 : 1, base + delta);
      shd[hole] = cur;
      return { ...prev, built: { ...prev.built, simpleHoleData: shd } };
    });
  };
  ...
  const ocrRebindVenue = (newVenueId) => {
    setOcr((prev) => {
      ...
      su.edited = { ...su.edited, course: true };
      return { ...prev, built, venueId: newVenueId || null, setup: su };
    });
    setOcrEditField(null);
    setVenueSearch("");
  };
  const ocrSetHalfCourse = (which, name) => {
    setOcr((prev) => {
      if (!prev) return prev;
      const built = { ...prev.built };
      if (which === "front") built.frontCourse = name;
      else built.backCourse = name;
      const edited = { ...prev.setup.edited };
      edited[which] = true;
      return { ...prev, built, setup: { ...prev.setup, edited } };
    });
    setOcrEditField(null);
  };
  const resumeRound = (r) => {
    ...
    const firstIncomplete = Array.from({ length: resumeHoleCount }, (_, i) => i + 1).find(
      (h) => r.inputMode === "simple" ? !r.simpleHoleData?.[h] : !r.holeData?.[h]?.done
    );
  ...
  const restoreFromTrash = (idx) => {
    ...
    const restored = exists ? { ...entry.round, id: Date.now() } : entry.round;
  ...
  const handicap = useMemo(() => {
    const completed = [...aggRounds.filter((r) => r.isComplete && (r.holePars?.length ?? 18) >= 18)].sort((a, b) => dateToNum(b.date) - dateToNum(a.date));
  ...
  const S = useMemo(() => ({
    ...
    card: (extra = {}) => ({ background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: "13px", padding: "16px", marginBottom: "12px", boxShadow: "0 1px 4px rgba(0,0,0,0.05)", ...extra }),
    btn: (v = "primary") => ({
      padding: "10px 18px",
      borderRadius: "9px",
      border: "none",
      ...
      fontWeight: "700",
      fontSize: "13px",
      ...v === "primary" && { background: "linear-gradient(135deg,#f59e0b,#ea580c)", color: "#ffffff", boxShadow: "0 3px 10px rgba(245,158,11,0.30)" },
      ...v === "secondary" && { background: "#f1f5f9", color: "#475569", border: "1px solid #e2e8f0" },
      ...v === "danger" && { background: "rgba(220,38,38,0.08)", color: "#dc2626", border: "1px solid rgba(220,38,38,0.30)" },
      ...v === "ghost" && { background: "transparent", color: "#94a3b8", padding: "5px 9px", fontSize: "12px" },
      ...v === "undo" && { background: "rgba(245,158,11,0.10)", color: "#d97706", border: "1px solid rgba(245,158,11,0.30)", padding: "8px 14px", fontSize: "12px" }
    }),
        ...
        return /* @__PURE__ */ React.createElement("div", { key: g.id, style: { marginBottom: "6px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "8px" } }, /* @__PURE__ */ React.createElement(
          "button",
          {
            onClick: () => setRoundGoal((prev) => ({
              type: g.id,
              target: sel ? Math.min(prev.target, maxVal) : Math.min(GOAL_DEFAULT_TARGET[g.id] ?? 3, maxVal)
            })),
            style: {
              flex: 1,
              padding: "9px 12px",
          ...
          "button",
          {
            onClick: () => setRoundGoal((prev) => ({ ...prev, target: Math.max(1, prev.target - 1) })),
          ...
          "button",
          {
            onClick: () => setRoundGoal((prev) => ({ ...prev, target: Math.min(maxVal, prev.target + 1) })),
            style: { width: "30px", height: "30px", borderRadius: "6px", border: "1px solid #e2e8f0", background: "#f8fafc", color: "#475569", cursor: "pointer", fontWeight: "800", fontSize: "16px" }
          },
          "\uFF0B"
        ), /* @__PURE__ */ React.createElement("span", { style: { fontSize: "11px", color: "#94a3b8", fontWeight: "600" } }, "H"))));
      });
    })()), canStart && venue && /* @__PURE__ */ React.createElement("div", { style: { background: "rgba(52,211,153,0.07)", border: "1px solid rgba(52,211,153,0.2)", borderRadius: "8px", padding: "10px 12px", marginBottom: "14px", fontSize: "12px", color: "#94a3b8" } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: "700", color: "#16a34a", marginBottom: "4px" } }, venue.name), /* @__PURE__ */ React.createElement("div", null, "\u524D\u534A\uFF1A", venue.subCourses[selectedCourseA].name, selectedCourseB === "none" ? " / \u5F8C\u534A\uFF1A\u306A\u3057\uFF089H\uFF09" : ` / \u5F8C\u534A\uFF1A${venue.subCourses[selectedCourseB].name}`), /* @__PURE__ */ React.createElement("div", null, "\u30B0\u30EA\u30FC\u30F3\uFF1A", venue.greens.length > 1 ? venue.greens.find((g) => g.id === selectedGreen)?.label : venue.greens[0].label, " / \u30C6\u30A3\u30FC\uFF1A", venue.tees.find((t) => t.id === selectedTee)?.label), /* @__PURE__ */ React.createElement("div", { style: { marginTop: "3px" } }, "\u65E5\u4ED8\uFF1A", selectedDate.replace(/(\d{4})\/(\d{2})\/(\d{2})/, (_, y, m, d) => `${y}/${+m}/${+d}`), "\u5929\u6C17\uFF1A", { "sunny": "\u2600\uFE0F\u6674\u308C", "cloudy": "\u2601\uFE0F\u66C7\u308A", "rainy": "\u{1F327}\uFE0F\u96E8", "snowy": "\u2744\uFE0F\u96EA" }[selectedWeather], "\u98A8\uFF1A", ["0\u301C1m/s", "1\u301C3m/s", "3\u301C5m/s", "5\u301C8m/s", "8\u301C12m/s", "12m/s\u301C"][selectedWind], "\uFF08", selectedWind, "\uFF09")), /* @__PURE__ */ React.createElement("button", { id: "round-start-btn", style: { ...S.btn("primary"), width: "100%", opacity: canStart ? 1 : 0.35, cursor: canStart ? "pointer" : "not-allowed" }, onClick: startRound, disabled: !canStart }, "\u30E9\u30A6\u30F3\u30C9\u958B\u59CB"));
  };
  const RoundCard = ({ r, teeRates }) => {
    ...
    const sa = hasSimpleData_ ? (() => {
      try {
        return calcAnalytics(r, r.excluded ? 0 : r.hcp ?? null, teeRates, avgDrive);
      } catch (e) {
        return null;
      }
    })() : null;
    ...
    return /* @__PURE__ */ React.createElement("div", { key: r.id, id: "rc-" + r.id, style: S.card() }, (() => {
      ...
      return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: isCollapsed ? "0px" : "10px" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement(
        ...
        "div",
        {
          onClick: () => {
            ...
            setEditGreen(r.green ?? null);
            setEditTee(r.tee ?? null);
            setEditMemo(r.memo || "");
          },
        ...
        const frontPar2 = frontHoles.reduce((a, h) => a + (r.holePars?.[h - 1] || 4), 0);
        const backPar2 = backHoles.reduce((a, h) => a + (r.holePars?.[h - 1] || 4), 0);
        ...
        const teeRateByPar = (par2) => {
          const target = Object.entries(shd).filter(([h, d]) => (pars[parseInt(h) - 1] || 4) === par2 && d?.teeEval);
        ...
        "button",
        {
          onClick: (e) => {
            ...
            requestAnimationFrame(() => {
              try {
                const _d = _btn.getBoundingClientRect().top - _before;
                if (Math.abs(_d) > 1) window.scrollBy(0, _d);
              } catch (_) {
              }
            });
          },
        ...
        const rows = [
          ...
          { label: "\u30D1\u30C3\u30C8\u6570", key: "putts", isEval: false, render: (h) => shd[h]?.putts ?? "\uFF0D", color: (h) => (shd[h]?.putts || 0) >= 3 ? "#dc2626" : "#e2e8f0", totalFn: (holes) => holes.reduce((a, h) => a + (shd[h]?.putts || 0), 0) },
          { label: "OB", key: "ob", isEval: false, render: (h) => shd[h]?.ob || "\uFF0D", color: (h) => (shd[h]?.ob || 0) > 0 ? "#dc2626" : "#475569", totalFn: (holes) => holes.reduce((a, h) => a + (shd[h]?.ob || 0), 0) },
          { label: "\u30DA\u30CA\u30EB\u30C6\u30A3", key: "penalty", isEval: false, render: (h) => shd[h]?.penalty || "\uFF0D", color: (h) => (shd[h]?.penalty || 0) > 0 ? "#dc2626" : "#475569", totalFn: (holes) => holes.reduce((a, h) => a + (shd[h]?.penalty || 0), 0) },
          { label: "\u30D0\u30F3\u30AB\u30FC", key: "bunker", isEval: false, render: (h) => shd[h]?.bunker || "\uFF0D", color: (h) => (shd[h]?.bunker || 0) > 0 ? "#fbbf24" : "#475569", totalFn: (holes) => holes.reduce((a, h) => a + (shd[h]?.bunker || 0), 0) },
          { label: "\u30C6\u30A3\u30B7\u30E7\u30C3\u30C8", key: "teeEval", isEval: true, render: (h) => evalLabel(shd[h]?.teeEval), color: (h) => evalColor(shd[h]?.teeEval), totalFn: (holes) => successRate(holes, "teeEval") }
        ];
      ...
      "div",
      {
        onClick: () => setRounds((prev) => prev.map((x) => x.id === r.id ? { ...x, excluded: !x.excluded } : x)),
      ...
      "input",
      {
        ...
        style: { ...S.input, marginBottom: "14px", colorScheme: "dark" }
      }
        ...
        onClick: () => {
          setRounds((prev) => prev.map((x) => {
            ...
            if (x.venueId && (editGreen != null && editGreen !== x.green || editTee != null && editTee !== x.tee)) {
              const res = applyRoundSettingsChange(x, x.holeData || null, { green: editGreen ?? x.green, tee: editTee ?? x.tee });
              if (res) {
                base = { ...res.round };
                if (res.holeData) {
            ...
            return { ...base, date: editDate, weather: editWeather, wind: editWind, memo: editMemo.trim().slice(0, 20) };
          }));
  ...
  return /* @__PURE__ */ React.createElement("div", { style: S.app }, /* @__PURE__ */ React.createElement("div", { style: S.header }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "7px" } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setView("home"), style: { display: "inline-block", lineHeight: 0, verticalAlign: "middle", background: "none", border: "none", padding: 0, cursor: "pointer", borderRadius: "6px", outline: "none" }, title: "\u30DB\u30FC\u30E0" }, /* @__PURE__ */ React.createElement("img", { src: "data:image/png;base64,", style: { width: "28px", height: "28px", borderRadius: "6px", display: "block" }, alt: "icon" })), /* @__PURE__ */ React.createElement("button", { onClick: () => setView("home"), title: "\u30DB\u30FC\u30E0", style: { background: "none", border: "none", padding: 0, cursor: "pointer", fontSize: "15px", fontWeight: "800", color: "#16a34a", letterSpacing: "0.02em", lineHeight: 1, whiteSpace: "nowrap" } }, "\u30B9\u30B3\u30EC\u30DC"), detailUnlocked ? /* @__PURE__ */ React.createElement("span", { style: { fontSize: "9px", fontWeight: "800", color: "#16a34a", background: "rgba(22,163,74,0.10)", border: "1px solid rgba(22,163,74,0.30)", borderRadius: "20px", padding: "2px 7px" } }, "PRO") : /* @__PURE__ */ React.createElement("button", { onClick: () => {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { position: "relative", display: "inline-flex" } }, /* @__PURE__ */ React.createElement("style", null, `@keyframes hcpPulse{0%{box-shadow:0 0 0 0 rgba(14,165,233,0.45)}70%{box-shadow:0 0 0 7px rgba(14,165,233,0)}100%{box-shadow:0 0 0 0 rgba(14,165,233,0)}}.hcp-pulse{animation:hcpPulse 2s ease-out infinite}@keyframes hcpHintIn{from{opacity:0;transform:translateY(-4px)}to{opacity:1;transform:translateY(0)}}.hcp-hint{animation:hcpHintIn .3s ease both}`), /* @__PURE__ */ React.createElement(
      "button",
      {
        ...
        style: { ...S.navBtn(view === "profile"), padding: "5px 9px", ...hcpUnset ? { background: "rgba(14,165,233,0.12)", color: "#0ea5e9", borderRadius: "20px" } : {} },
        onClick: () => {
    ...
    } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: "32px", fontWeight: "800", color, lineHeight: 1 } }, value ?? "\uFF0D"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: "9px", fontWeight: "700", color: "#94a3b8", marginTop: "4px", whiteSpace: "nowrap" } }, label))));
  })(), showHcDefs && /* @__PURE__ */ React.createElement("div", { style: { marginTop: "8px", fontSize: "9px", color: "#94a3b8", fontStyle: "italic", lineHeight: 1.7 } }, "\u203B\u30CF\u30F3\u30C7\u30A3\u30AD\u30E3\u30C3\u30D7\uFF1A\u5DEE\u5206\u5E73\u5747\u65B9\u5F0F\u306B\u3088\u308B\u53C2\u8003\u5024\u3002\u516C\u5F0F\u3068\u306F\u7570\u306A\u308A\u307E\u3059", /* @__PURE__ */ React.createElement("br", null), "\u203B\u30D9\u30B9\u30C8\u30B9\u30B3\u30A2\uFF1A\u5168\u8A18\u9332\u30E9\u30A6\u30F3\u30C9\u3068\u30DE\u30A4\u30DA\u30FC\u30B8\u81EA\u5DF1\u7533\u544A\u306E\u3046\u3061\u5C0F\u3055\u3044\u65B9", /* @__PURE__ */ React.createElement("br", null), "\u203B\u5E73\u5747\u30FB\u4E2D\u592E\u5024\uFF1A\u76F4\u8FD120\u30E9\u30A6\u30F3\u30C9\u304B\u3089\u7B97\u51FA")) : rounds.filter((r) => r.isComplete).length > 0 ? /* @__PURE__ */ React.createElement("div", { style: { ...S.card({ marginBottom: "18px", border: "1px solid rgba(96,165,250,0.15)" }), fontSize: "12px", color: "#475569", textAlign: "center", padding: "12px" } }, "\u30CF\u30F3\u30C7\u30A3\u30AD\u30E3\u30C3\u30D7\u7B97\u51FA\u306B\u306F18H\u5B8C\u4E86\u30E9\u30A6\u30F3\u30C9\u304C3\u4EF6\u4EE5\u4E0A\u5FC5\u8981\u3067\u3059\uFF08\u73FE\u5728 ", rounds.filter((r) => r.isComplete).length, "\u4EF6\uFF09") : null, !showNewRound ? /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: "10px", marginBottom: "18px" } }, (() => {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: "8px", marginBottom: "12px" } }, /* @__PURE__ */ React.createElement(
      ...
      "button",
      {
        style: { ...S.btn("secondary"), width: "100%", padding: "10px" },
    ...
    if (ocrStep === "setup") {
      ...
      } }, "\u6B21\u3078\uFF1A\u30B9\u30B3\u30A2\u767B\u9332"), /* @__PURE__ */ React.createElement("div", { style: { height: "10px" } }), /* @__PURE__ */ React.createElement("button", { style: { ...S.btn("secondary"), width: "100%" }, onClick: ocrBackToData }, "\u6700\u521D\u306B\u623B\u308B"), SHOW_OCR_DEBUG && ocr.meta && ocr.meta.ocrDebug && /* @__PURE__ */ React.createElement("div", { style: { marginTop: "12px", background: "#0f172a", color: "#e2e8f0", borderRadius: "10px", padding: "12px", fontSize: "10px", lineHeight: 1.5, fontFamily: "monospace", overflowX: "auto", wordBreak: "break-all" } }, /* @__PURE__ */ React.createElement("button", { onClick: (e) => {
    ...
    if (ocrStep === "score") {
      ...
      const renderGrid = (keys, label) => {
        ...
        return /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", border: "1px solid #e2e8f0", borderRadius: "12px", overflow: "hidden", marginBottom: "12px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "42px 1fr 1fr 1fr 1fr", background: "#f1f5f9", padding: "7px 8px" } }, ["H", "\u30B9\u30B3\u30A2", "\u30D1\u30C3\u30C8", "\u30C6\u30A3", "\u30A2\u30D7"].map((h, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { textAlign: i === 0 ? "left" : "center", fontSize: "10px", color: "#64748b", fontWeight: "700" } }, h))), keys.map((k) => {
          ...
          return /* @__PURE__ */ React.createElement("button", { key: k, onClick: () => setOcrSel({ hole: k }), style: { display: "grid", gridTemplateColumns: "42px 1fr 1fr 1fr 1fr", alignItems: "center", padding: "7px 8px", width: "100%", textAlign: "left", background: sel ? "rgba(245,158,11,0.10)" : "#fff", border: "none", borderTop: "1px solid #e2e8f0", cursor: "pointer" } }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { style: { fontWeight: "800", fontSize: "14px" } }, dispHole), /* @__PURE__ */ React.createElement("span", { style: { display: "block", fontSize: "9px", color: "#94a3b8" } }, "P", d.par, obpb ? " " + obpb : "")), /* @__PURE__ */ React.createElement("span", { style: { ...cellBase, color: scoreColor2 } }, d.score == null ? "\u2014" : d.score), /* @__PURE__ */ React.createElement("span", { style: { ...cellBase, color: puttEmpty ? "#b45309" : "#1e293b", ...puttEmpty ? { borderColor: "rgba(251,191,36,0.55)", background: "rgba(251,191,36,0.08)" } : {} } }, puttEmpty ? "\u2014" : d.putts), /* @__PURE__ */ React.createElement("span", { style: { ...cellBase, color: evColor[d.teeEval] || "#16a34a" } }, evLabel[d.teeEval] || "\u25CB"), /* @__PURE__ */ React.createElement("span", { style: { ...cellBase, color: evColor[d.approachEval] || "#94a3b8" } }, evLabel[d.approachEval] || "\u7121"));
    ...
    const setShd = (patch) => setSimpleHoleData((prev) => ({
      ...prev,
      [currentHole]: { ...prev[currentHole] || {}, ...patch }
    }));
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" } }, /* @__PURE__ */ React.createElement("div", { onClick: currentRound.venueId ? openRoundSettings : void 0, style: { cursor: currentRound.venueId ? "pointer" : "default" } }, /* @__PURE__ */ React.createElement("h2", { style: { fontSize: "16px", fontWeight: "800" } }, (currentRound.course || "").replace(/（[^）]*）\s*$/, "") || currentRound.course, currentRound.venueId && /* @__PURE__ */ React.createElement("span", { style: { fontSize: "10px", color: "#0ea5e9", fontWeight: "700", marginLeft: "6px" } }, "\u270F\uFE0F \u8A2D\u5B9A")), /* @__PURE__ */ React.createElement("p", { style: { color: "#94a3b8", fontSize: "11px", marginTop: "1px" } }, simpleRecCount, "\u30DB\u30FC\u30EB\u8A18\u9332\u6E08\u307F\u3000\u5408\u8A08 ", /* @__PURE__ */ React.createElement("span", { style: { color: "#1e293b", fontWeight: "700" } }, simpleTotalScore), "\u6253", simpleRecCount > 0 && /* @__PURE__ */ React.createElement("span", { style: { color: scoreDiffSymbol(simpleRecDiff).color } }, "\uFF08", simpleRecDiff >= 0 ? "+" : "", simpleRecDiff, "\uFF09"), (() => {
    ...
    })(), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", marginBottom: "14px" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { style: S.lbl }, "\u30B9\u30B3\u30A2\uFF08\u6253\u6570\uFF09"), /* @__PURE__ */ React.createElement(NumInput, { val: shd.score ?? par, onChange: (v) => {
      const maxPutts = Math.max(0, v - 1);
      const currentPutts = shd.putts ?? 0;
      setShd({ score: v, ...currentPutts > maxPutts ? { putts: maxPutts } : {} });
    }, min: 1, max: 20 })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { style: S.lbl }, "\u30D1\u30C3\u30C8\u6570"), /* @__PURE__ */ React.createElement(NumInput, { val: shd.putts, onChange: (v) => setShd({ putts: v }), min: 0, max: Math.max(0, (shd.score ?? par) - 1) }))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "10px", marginBottom: "14px" } }, [
      { key: "ob", label: "OB" },
      ...
      return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: "8px" } }, currentHole !== firstHole && /* @__PURE__ */ React.createElement("button", { style: { ...S.btn("secondary"), flex: 1 }, onClick: () => {
        if (currentHole === _backFirstHole) {
          setCurrentHole(_frontLastHole);
        } else {
          setCurrentHole(currentHole - 1);
        }
      } }, "\u2039 \u524D\u306E\u30DB\u30FC\u30EB"), currentHole !== lastHole ? /* @__PURE__ */ React.createElement("button", { style: { ...S.btn("primary"), flex: 1 }, onClick: () => {
        ...
        scoreToast(sc, par);
        moveToHole(nextHole);
      } }, "\u6B21\u306E\u30DB\u30FC\u30EB \u203A") : /* @__PURE__ */ React.createElement("button", { style: { ...S.btn("danger"), flex: 1 }, onClick: () => {
        setSimpleHoleData((prev) => {
          const h = prev[currentHole] || {};
          const needsSave = h.score == null || h.putts === void 0;
          if (!needsSave) return prev;
    ...
    const style = ep > 0 ? { ...baseStyle, background: "#b91c1c", color: "#ffffff" } : { ...baseStyle, background: "#fee2e2", color: "#b91c1c" };
    return /* @__PURE__ */ React.createElement(
      "button",
      {
        style,
    ...
    return /* @__PURE__ */ React.createElement("div", { style: S.card({ padding: "12px 10px", marginBottom: "10px" }) }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" } }, /* @__PURE__ */ React.createElement("label", { style: { ...S.lbl, margin: 0 } }, "\u30E4\u30FC\u30C7\u30FC\u30B8\u8868\uFF08", teeLabel, "\uFF09"), /* @__PURE__ */ React.createElement("button", { style: S.btn("ghost"), onClick: () => setShowYardage(false) }, "\u2715")), /* @__PURE__ */ React.createElement("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: "12px" } }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", { style: { color: "#475569" } }, ["H", "Par", "HDCP", "\u8DDD\u96E2(Y)"].map((h) => /* @__PURE__ */ React.createElement("th", { key: h, style: { padding: "5px 4px", textAlign: "center", borderBottom: "1px solid #e2e8f0", fontWeight: "700" } }, h)))), /* @__PURE__ */ React.createElement("tbody", null, allHoles.map((h, i) => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("td", { style: { padding: "5px 4px", textAlign: "center", color: "#fbbf24", fontWeight: "700" } }, yard ?? "\u2014")
      );
  ...
  })(), /* @__PURE__ */ React.createElement("div", { style: S.card({ padding: "13px 14px" }) }, /* @__PURE__ */ React.createElement("label", { style: S.lbl }, "\u30DB\u30FC\u30EB\u9078\u629E"), [{ label: currentRound?.frontCourse || "\u524D\u534A", holes: [1, 2, 3, 4, 5, 6, 7, 8, 9] }, { label: currentRound?.backCourse || "\u5F8C\u534A", holes: [10, 11, 12, 13, 14, 15, 16, 17, 18] }].map((row, ri) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { marginBottom: "12px" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "6px", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", { style: { fontWeight: "700", fontSize: "14px" } }, getDisplayHoleNum(currentHole), "\u756A"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: "4px" } }, [3, 4, 5].map((p) => /* @__PURE__ */ React.createElement(
      ...
      "button",
      {
        onClick: () => {
          ...
          setHoleData((p) => ({ ...p, [currentHole]: { shots: prev, state, done: false, pinDist: void 0, extraPenalty: p[currentHole]?.extraPenalty } }));
        },
  ...
  ) : hd.done ? /* @__PURE__ */ React.createElement(React.Fragment, null, currentHole > 1 && /* @__PURE__ */ React.createElement("button", { style: { ...S.btn("secondary"), padding: "10px 14px", fontSize: "12px" }, onClick: () => setCurrentHole((h) => h - 1) }, "\u2039 \u524D\u306E\u30DB\u30FC\u30EB"), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, textAlign: "center", padding: "12px", color: "#16a34a", fontSize: "13px", fontWeight: "700" } }, "\u30DB\u30FC\u30EB\u5B8C\u4E86", (hd.pinDistM != null || hd.pinDist) && /* @__PURE__ */ React.createElement("div", { style: { fontSize: "10px", color: "#0ea5e9", fontWeight: "600", marginTop: "2px" } }, hd.pinDistM != null ? hd.pinDistM + "m" : hd.pinDist)), currentHole < holePars.length ? /* @__PURE__ */ React.createElement("button", { style: { ...S.btn("primary"), padding: "10px 14px", fontSize: "12px" }, onClick: () => setCurrentHole((h) => h + 1) }, "\u6B21\u306E\u30DB\u30FC\u30EB \u203A") : /* @__PURE__ */ React.createElement("button", { style: { ...S.btn("danger"), padding: "10px 18px", fontSize: "13px", fontWeight: "800" }, onClick: handleDetailFinishClick }, "\u30E9\u30A6\u30F3\u30C9\u7D42\u4E86")) : null, !hd.done && hd.shots.length > 0 && /* @__PURE__ */ React.createElement("button", { style: S.btn("undo"), onClick: undoLastShot }, "\u21A9 \u53D6\u6D88"))), showExtraPenaltyModal && /* @__PURE__ */ React.createElement(
    "div",
    {
      style: {
        position: "fixed",
        ...
        "button",
        {
          ...
          onClick: () => {
            ...
            setHoleData((prev) => {
              ...
              return { ...prev, [currentHole]: { ...existing, extraPenalty: val } };
            });
    ...
    "button",
    {
      ...
      style: { ...S.btn("primary"), width: "100%", padding: "13px", marginBottom: "9px" }
    },
    DETAIL_PRICE_LABEL,
    "\u3067\u89E3\u9664\u3059\u308B\uFF08\u8CFC\u5165\uFF09"
  ...
  ), /* @__PURE__ */ React.createElement("button", { onClick: applyUnlockCode, style: { ...S.btn("secondary"), whiteSpace: "nowrap" } }, "\u9069\u7528")), unlockError && /* @__PURE__ */ React.createElement("div", { style: { fontSize: "11px", color: "#dc2626", fontWeight: "700", marginTop: "6px" } }, unlockError)), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => {
        setShowDetailPaywall(false);
    ...
    "button",
    {
      onClick: () => setProfileEdit((p) => ({ ...p, bestScore: Math.max(54, (p.bestScore || 72) - 1) })),
    ...
    "\u2212"
  ), /* @__PURE__ */ React.createElement("span", { style: { minWidth: "48px", textAlign: "center", fontSize: "22px", fontWeight: "800", color: "#fbbf24" } }, profileEdit.bestScore ?? "\u2212"), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => setProfileEdit((p) => ({ ...p, bestScore: Math.min(200, (p.bestScore || 71) + 1) })),
      style: { width: "36px", height: "36px", borderRadius: "8px", border: "1px solid rgba(255,255,255,0.15)", background: "#f8fafc", color: "#1e293b", cursor: "pointer", fontSize: "18px", fontWeight: "700" }
    },
    "\uFF0B"
    ...
    "button",
    {
      onClick: () => setProfileEdit((p) => ({ ...p, bestScore: null })),
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      {
        key,
        onClick: () => setProfileEdit((p) => ({ ...p, hcpMode: key })),
        style: {
          flex: 1,
          padding: "10px 6px",
          borderRadius: "10px",
    ...
    "\u2212"
  ), /* @__PURE__ */ React.createElement("span", { style: { minWidth: "48px", textAlign: "center", fontSize: "22px", fontWeight: "800", color: "#f59e0b" } }, profileEdit.manualHcp ?? "\u2212"), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => setProfileEdit((p) => ({ ...p, manualHcp: Math.min(54, (p.manualHcp ?? 19) + 1) })),
      style: { width: "36px", height: "36px", borderRadius: "8px", border: "1px solid #e2e8f0", background: "#f8fafc", color: "#1e293b", cursor: "pointer", fontSize: "18px", fontWeight: "700" }
    },
    "\uFF0B"
    ...
    "button",
    {
      onClick: () => setProfileEdit((p) => ({ ...p, manualHcp: null })),
      style: { padding: "4px 10px", borderRadius: "6px", border: "1px solid #e2e8f0", background: "transparent", color: "#475569", cursor: "pointer", fontSize: "11px" }
    },
    "\u30AF\u30EA\u30A2"
    ...
    "button",
    {
      onClick: () => setProfileEdit((p) => ({ ...p, targetHcp: Math.max(0, (p.targetHcp ?? 11) - 1) })),
      style: { width: "36px", height: "36px", borderRadius: "8px", border: "1px solid rgba(255,255,255,0.15)", background: "#f8fafc", color: "#1e293b", cursor: "pointer", fontSize: "18px", fontWeight: "700" }
    },
    "\u2212"
  ), /* @__PURE__ */ React.createElement("span", { style: { minWidth: "48px", textAlign: "center", fontSize: "22px", fontWeight: "800", color: "#0ea5e9" } }, profileEdit.targetHcp ?? "\u2212"), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => setProfileEdit((p) => ({ ...p, targetHcp: Math.min(54, (p.targetHcp ?? 9) + 1) })),
      style: { width: "36px", height: "36px", borderRadius: "8px", border: "1px solid rgba(255,255,255,0.15)", background: "#f8fafc", color: "#1e293b", cursor: "pointer", fontSize: "18px", fontWeight: "700" }
    },
    "\uFF0B"
    ...
    "button",
    {
      onClick: () => setProfileEdit((p) => ({ ...p, targetHcp: null })),
      style: { padding: "4px 10px", borderRadius: "6px", border: "1px solid #e2e8f0", background: "transparent", color: "#475569", cursor: "pointer", fontSize: "11px" }
    },
    "\u30AF\u30EA\u30A2"
    ...
    DrumPicker,
    {
      value: profileEdit.driveFrom ?? 180,
      min: 100,
      max: 395,
      step: 5,
      onChange: (v) => setProfileEdit((p) => {
        const to = p.driveTo ?? 230;
        return { ...p, driveFrom: v, driveTo: v >= to ? Math.min(400, v + 5) : to };
      })
    }
    ...
    return /* @__PURE__ */ React.createElement("div", { key: vid, style: { display: "flex", alignItems: "center", gap: "8px", padding: "9px 12px", borderRadius: "9px", background: "#f8fafc", border: "1px solid #e2e8f0" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: "12px", color: "#f59e0b", minWidth: "16px" } }, "\u2605"), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, fontSize: "13px", color: "#1e293b", fontWeight: "500" } }, v.name), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: "4px" } }, idx > 0 && /* @__PURE__ */ React.createElement("button", { onClick: () => {
      ...
      setProfileEdit((p) => ({ ...p, favoriteVenues: arr }));
      ...
      "button",
      {
        onClick: () => setProfileEdit((p) => ({ ...p, favoriteVenues: (p.favoriteVenues || []).filter((x) => x !== vid) })),
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { maxHeight: "180px", overflowY: "auto", WebkitOverflowScrolling: "touch", border: "1px solid #e2e8f0", borderRadius: "10px", background: "#ffffff" } }, sorted.map((v, i) => /* @__PURE__ */ React.createElement(
      ...
      {
        key: v.id,
        onClick: () => setProfileEdit((p) => ({ ...p, favoriteVenues: [...p.favoriteVenues || [], v.id] })),
        style: {
          width: "100%",
          textAlign: "left",
          padding: "9px 12px",
    ...
    "button",
    {
      ...
      style: { ...S.btn("primary"), width: "100%", fontSize: "13px", padding: "12px" }
    },
    "JSON\u3092\u8868\u793A\u3059\u308B\uFF08",
    rounds.length,
    "\u4EF6\uFF09"
  ...
  })), /* @__PURE__ */ React.createElement("div", { style: S.card() }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: "12px", fontWeight: "800", color: "#1e293b", marginBottom: "4px" } }, "\u81EA\u52D5\u30D0\u30C3\u30AF\u30A2\u30C3\u30D7\uFF081\u65E51\u56DE\uFF09"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: "11px", color: "#64748b", marginBottom: "10px", lineHeight: 1.6 } }, dailyBackup ? "\u524D\u56DE\u30D0\u30C3\u30AF\u30A2\u30C3\u30D7: " + dailyBackup.date.replace(/^\d+\/0?(\d+)\/0?(\d+)$/, "$1/$2") + "\uFF08" + dailyBackup.rounds.length + "\u4EF6\uFF09" : "\u30D0\u30C3\u30AF\u30A2\u30C3\u30D7\u306F\u307E\u3060\u3042\u308A\u307E\u305B\u3093"), dailyBackup && /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: restoreFromDailyBackup,
      style: { ...S.btn("secondary"), width: "100%", fontSize: "12px", padding: "10px" }
    },
    "\u30D0\u30C3\u30AF\u30A2\u30C3\u30D7\u304B\u3089\u5FA9\u5143"
    ...
    "button",
    {
      style: { ...S.btn("primary"), width: "100%", padding: "14px", fontSize: "14px" },
      onClick: () => {
        if (currentRound) {
    ...
    } }, /* @__PURE__ */ React.createElement("style", null, SLIDER_CSS), /* @__PURE__ */ React.createElement("div", { style: {
      ...S.modalBox,
      padding: 0,
      display: "flex",
      flexDirection: "column",
