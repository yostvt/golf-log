...
var CLUB_CATEGORIES = ["\u30A6\u30C3\u30C9", "\u30E6\u30FC\u30C6\u30A3\u30EA\u30C6\u30A3", "\u30A2\u30A4\u30A2\u30F3", "\u30A6\u30A7\u30C3\u30B8", "\u30D1\u30BF\u30FC"];
...
var calcIdealGIR = (hcp, holeCount) => {
...
var LONG_DIST_SET = /* @__PURE__ */ new Set(["150Y\u4EE5\u5185", "200Y\u4EE5\u5185", "250Y\u4EE5\u5185", "250Y\u8D85"]);
var SHORT_DIST_SET = /* @__PURE__ */ new Set(["10Y\u4EE5\u5185", "20Y\u4EE5\u5185", "30Y\u4EE5\u5185", "40Y\u4EE5\u5185", "50Y\u4EE5\u5185", "100Y\u4EE5\u5185"]);
...
var _calcAnalyticsMemo = /* @__PURE__ */ new WeakMap();
...
var RoundCardErrorBoundary = class extends React.Component {
  constructor(props) {
    super(props);
...
var PUTT_LABEL_M = { "1m\u4EE5\u5185": 1, "2m\u4EE5\u5185": 2, "3m\u4EE5\u5185": 3, "4m\u4EE5\u5185": 4, "5m\u4EE5\u5185": 5, "10m\u4EE5\u5185": 8, "15m\u4EE5\u5185": 13, "20m\u4EE5\u5185": 18, "20m\u8D85": 25 };
var ES_SEGMENTS = [
...
var EXPORT_MARKER = "x9q7m2k4z8r3";
var hasExportMarker = (nick) => typeof nick === "string" && nick.indexOf(EXPORT_MARKER) !== -1;
var stripExportMarker = (nick) => typeof nick === "string" ? nick.split(EXPORT_MARKER).join("").trim() : nick;
...
var AnalyticsAIDiagnosisImpl = ({ rounds, avgDrive, effectiveHcp }) => {
  const parseDate = (d) => {
    const p = (d || "").split("/").map(Number);
...
var AnalyticsScoreChartImpl = ({ rounds, avgDrive, S }) => {
...
var renderTrend = (n5, n20, betterLow, unit, mult) => {
...
var AnalyticsStatsImpl = ({ rounds, handicap, profile, S }) => {
  const allCompleted = [...rounds.filter((r) => r.isComplete && Object.keys(r.simpleHoleData || {}).length > 0)].sort((a, b) => dateToNum(b.date) - dateToNum(a.date));
  const sc20 = allCompleted.slice(0, 20);
  const sc5 = allCompleted.slice(0, 5);
...
var AnalyticsDistanceStatsImpl = ({ rounds, S }) => {
...
var AnalyticsClubStatsImpl = ({ rounds, S }) => {
...
var AnalyticsSegmentChartsImpl = ({ rounds, S }) => {
...
var ToastLayer = React.memo(function ToastLayer2({ toast, weather }) {
...
var PinDistModal = React.memo(function PinDistModal2({ holeNumLabel, onSelect }) {
...
var ExportModal = React.memo(function ExportModal2({ roundsCount, exportJson, onClose }) {
...
var AnalyticsAIDiagnosis = React.memo(AnalyticsAIDiagnosisImpl);
var AnalyticsScoreChart = React.memo(AnalyticsScoreChartImpl);
var AnalyticsStats = React.memo(AnalyticsStatsImpl);
var AnalyticsPuttStats = React.memo(AnalyticsPuttStatsImpl);
var AnalyticsDistanceStats = React.memo(AnalyticsDistanceStatsImpl);
var AnalyticsClubStats = React.memo(AnalyticsClubStatsImpl);
var AnalyticsSegmentCharts = React.memo(AnalyticsSegmentChartsImpl);
var ManualView = React.memo(ManualViewImpl);
...
if(typeof window!=="undefined"&&document.getElementById("root")){ReactDOM.createRoot(document.getElementById("root")).render(React.createElement(GolfTracker));}