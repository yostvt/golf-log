...
function AiDiagnosisPanel({ sa, sa5 = null, shd, hcp, rounds, roundId, teeRates = null, showTrend = true, label = "AI \u30B9\u30B3\u30A2\u8A3A\u65AD", roundCount = null, dateRange = null, radarSlot = null, rexyTip = false }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { marginTop: "12px" } }, /* @__PURE__ */ React.createElement("style", null, `
    ...
    return /* @__PURE__ */ React.createElement("div", null, hasCmp && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "flex-end", gap: "0", fontSize: "8px", color: "#94a3b8", marginBottom: "6px" } }, /* @__PURE__ */ React.createElement("span", { style: { minWidth: "38px", textAlign: "right", fontWeight: "700" } }, "\u76F4\u8FD15R"), /* @__PURE__ */ React.createElement("span", { style: { minWidth: "34px", textAlign: "right" } }, "20R")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: "6px", marginBottom: "5px" } }, /* @__PURE__ */ React.createElement("span", { style: { width: "26px", flexShrink: 0 } }), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, position: "relative", height: "11px", fontSize: "9px", fontWeight: "800", lineHeight: 1 } }, /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", left: 0, top: 0, color: "#2563eb" } }, "\u25B3"), /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", left: "50%", top: 0, transform: "translateX(-50%)", color: "#94a3b8" } }, "0"), /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", right: 0, top: 0, color: "#16a34a" } }, "\uFF0B")), /* @__PURE__ */ React.createElement("span", { style: { minWidth: "38px", flexShrink: 0 } }), hasCmp && /* @__PURE__ */ React.createElement("span", { style: { minWidth: "34px", flexShrink: 0 } })), ITEMS.map((it) => /* @__PURE__ */ React.createElement(Row, { key: it.key, abbr: it.abbr, main: hasCmp ? v5(it.key) : v20(it.key), cmp: v20(it.key) })), v20("bunkerScore") != null && /* @__PURE__ */ React.createElement("div", { style: { marginTop: "8px", paddingTop: "8px", borderTop: "1px solid #e2e8f0" } }, /* @__PURE__ */ React.createElement(Row, { abbr: "BK", main: hasCmp ? v5("bunkerScore") : v20("bunkerScore"), cmp: v20("bunkerScore") })), sa.sg.holes && sa.sg.holes.length > 0 && (() => {
