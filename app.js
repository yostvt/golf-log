...
function GolfTracker() {
  ...
  const AnalyticsPuttStats = () => {
    ...
    if (rows.length === 0) return /* @__PURE__ */ React.createElement(StatsLockedCard, { title: "\u8DDD\u96E2\u5225\u30D1\u30C3\u30C8\u7D71\u8A08", desc: "\u8A73\u7D30\u30E2\u30FC\u30C9\u3067\u30D1\u30C3\u30C8\u8DDD\u96E2\u3092\u8A18\u9332\u3059\u308B\u3068\u30011m\u30FB2m\u30FB3m\u2026\u306E\u8DDD\u96E2\u5225\u30D1\u30C3\u30C8\u6210\u529F\u7387\uFF081\u30D1\u30C3\u30C8\u7387\u30FB3\u30D1\u30C3\u30C8\u7387\uFF09\u304C\u898B\u3089\u308C\u307E\u3059\u3002" });
  ...
  const AnalyticsDistanceStats = () => {
    ...
    if (allShots.length === 0) return /* @__PURE__ */ React.createElement(StatsLockedCard, { title: "\u6B8B\u308A\u8DDD\u96E2\u5225 \u25CB/\xD7\u7387", desc: "\u8A73\u7D30\u30E2\u30FC\u30C9\u30671\u6253\u305A\u3064\uFF08\u6B8B\u308A\u8DDD\u96E2\u30FB\u7D50\u679C\uFF09\u3092\u8A18\u9332\u3059\u308B\u3068\u3001\u6B8B\u308A\u8DDD\u96E2\u5E2F\u3054\u3068\u306E\u30CA\u30A4\u30B9\u30B7\u30E7\u30C3\u30C8\u7387\uFF08\u25CB\u7387\u30FB\xD7\u7387\uFF09\u304C\u898B\u3089\u308C\u307E\u3059\u3002" });
    const BANDS = [];
    ...
    allShots.forEach((s) => {
      var _a2;
      const d = s.remainDistRaw != null && Number.isFinite(s.remainDistRaw) && s.remainDistRaw > 0 ? s.remainDistRaw : (_a2 = DIST_LABEL_MID[s.remainDist]) != null ? _a2 : null;
    ...
    if (rows.length === 0) return /* @__PURE__ */ React.createElement(StatsLockedCard, { title: "\u6B8B\u308A\u8DDD\u96E2\u5225 \u25CB/\xD7\u7387", desc: "\u8A73\u7D30\u30E2\u30FC\u30C9\u30671\u6253\u305A\u3064\uFF08\u6B8B\u308A\u8DDD\u96E2\u30FB\u7D50\u679C\uFF09\u3092\u8A18\u9332\u3059\u308B\u3068\u3001\u6B8B\u308A\u8DDD\u96E2\u5E2F\u3054\u3068\u306E\u30CA\u30A4\u30B9\u30B7\u30E7\u30C3\u30C8\u7387\uFF08\u25CB\u7387\u30FB\xD7\u7387\uFF09\u304C\u898B\u3089\u308C\u307E\u3059\u3002" });
  ...
  const AnalyticsClubStats = () => {
    ...
    if (allShots.length === 0) return /* @__PURE__ */ React.createElement(StatsLockedCard, { title: "\u30AF\u30E9\u30D6\u5225 \u25CB/\xD7\u7387", desc: "\u8A73\u7D30\u30E2\u30FC\u30C9\u3067\u4F7F\u7528\u30AF\u30E9\u30D6\u3092\u8A18\u9332\u3059\u308B\u3068\u3001\u30AF\u30E9\u30D6\u3054\u3068\u306E\u30CA\u30A4\u30B9\u30B7\u30E7\u30C3\u30C8\u7387\uFF08\u25CB\u7387\u30FB\xD7\u7387\uFF09\u304C\u898B\u3089\u308C\u307E\u3059\u3002" });
    const clubMap = {};
    allShots.forEach((s) => {
    ...
    if (rows.length === 0) return /* @__PURE__ */ React.createElement(StatsLockedCard, { title: "\u30AF\u30E9\u30D6\u5225 \u25CB/\xD7\u7387", desc: "\u8A73\u7D30\u30E2\u30FC\u30C9\u3067\u4F7F\u7528\u30AF\u30E9\u30D6\u3092\u8A18\u9332\u3059\u308B\u3068\u3001\u30AF\u30E9\u30D6\u3054\u3068\u306E\u30CA\u30A4\u30B9\u30B7\u30E7\u30C3\u30C8\u7387\uFF08\u25CB\u7387\u30FB\xD7\u7387\uFF09\u304C\u898B\u3089\u308C\u307E\u3059\u3002" });
