...
function AnalyticsExpectedStrokes({ rounds, hcp, S, nickname }) {
  ...
  if (effMode === "curve") {
    ...
    }), tgtPts && /* @__PURE__ */ React.createElement("polyline", { points: tgtPts, fill: "none", stroke: "#94a3b8", strokeWidth: "2", strokeDasharray: "5 4" }), rows.map((r, i) => nb > 10 && i % 2 === 1 ? null : /* @__PURE__ */ React.createElement("text", { key: i, x: xAt(i), y: H - padB + 12, textAnchor: "middle", fontSize: "9", fill: "#64748b" }, r.band)));
  } else {
